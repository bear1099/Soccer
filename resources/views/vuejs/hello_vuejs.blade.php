...
<div class="container">
    ...
    <div id="hello_vuejs">
        ...
        <div>
            ...
            <helloworld_props-component :message="showMessage"></helloworld_props-component><!--v-bind:の省略記法は:のみ、データをバインドする。""はJavaScriptを書ける。-->
        </div>
        ...
        <div>
            ...
            <div><button type="submit" class="btn btn-primary" id="change" @click="changeMessage()">Change Message</button></div><!--ボタンをクリックしたときchangeMessageメソッドを実行-->
        </div>
        ...
        <div :style="{ display: isDisplay }"><!-- v-bind:styleを指定することでCSSを変更できる。 -->
